...
const GroupCardLanding = ({group}: {group: GroupDtoOld}) => (
        <div className="w-[230px] h-[192px] rounded-lg bg-pink-200/70 p-2 m-1 shadow-md hover:transition-all hover:-translate-y-0.5 hover:-translate-x-0.5 hover:shadow-lg">
            <div className="flex justify-center">
